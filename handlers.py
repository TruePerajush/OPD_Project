...
def init_bot(app: TeleBot, conn, sql_cursor):
    ...
    def goals_confirmation(message: Message):
        ...
        reminder_confirmation_menu = [
            [
                InlineKeyboardButton(
                    "Да", callback_data="goals_reminder_confirmation_yes"
                ),
                InlineKeyboardButton(
                    "Нет", callback_data="goals_reminder_confirmation_no"
                ),
            ]
        ]
    ...
    @app.callback_query_handler(
        func=lambda call: call.data == "goals_reminder_confirmation_yes"
    )
    ...
    @app.callback_query_handler(
        func=lambda call: call.data == "goals_reminder_confirmation_no"
    )
